...
test.describe('Login Tests', () => {
   ...
   */
  test('TC-001: Verify login page elements are visible', async ({ page }) => {
   ...
   */
  test('TC-002: Verify login validation when both fields are empty', async ({ page }) => {
   ...
   */
  test('TC-003: Verify login fails with email only', async ({ page }) => {
   ...
   */
  test('TC-004: Verify login fails with password only', async ({ page }) => {
   ...
   */
  test('TC-005: Verify login fails with invalid email and valid password', async ({ page }) => {
   ...
   */
  test('TC-006: Verify login fails with valid email and incorrect password', async ({ page }) => {
    const email = process.env.USER_EMAIL || 'traineeautomation@yopmail.com';
   ...
   */
  test('TC-007: Verify password visibility toggle functionality', async ({ page }) => {
    const password = process.env.USER_PASSWORD || 'Trainee@123';
   ...
   */
  test('TC-008: Verify forgot password page accessibility', async ({ page }) => {
   ...
   */
  test('TC-009: Verify forgot password validation when email is blank', async ({ page }) => {
    await loginPage.openForgotPassword();
    await loginPage.verifyForgotPasswordPage();
   ...
   */
  test('TC-010: Verify remember me checkbox functionality', async ({ page }) => {
   ...
   */
  test('TC-011: Verify successful login with valid credentials', async ({ page }) => {
    const email = process.env.USER_EMAIL || 'traineeautomation@yopmail.com';
    const password = process.env.USER_PASSWORD || 'Trainee@123';
   ...
   */
  test('TC-012: Verify Users link is visible after login', async ({ page }) => {
    const email = process.env.USER_EMAIL || 'traineeautomation@yopmail.com';
    const password = process.env.USER_PASSWORD || 'Trainee@123';
   ...
   */
  test('TC-013: Verify Users page elements are visible', async ({ page }) => {
    const email = process.env.USER_EMAIL || 'traineeautomation@yopmail.com';
    const password = process.env.USER_PASSWORD || 'Trainee@123';
   ...
   */
  test('TC-014: Verify logout functionality', async ({ page }) => {
    const email = process.env.USER_EMAIL || 'traineeautomation@yopmail.com';
    const password = process.env.USER_PASSWORD || 'Trainee@123';
